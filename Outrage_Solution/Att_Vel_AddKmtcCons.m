function res = Att_Vel_AddKmtcCons(imu, mavp, imuerr, davp,avp0,index)
%% -----------Introduction------------
%姿态匹配+速度匹配  23维传递对准算法 估计主子安装角，杆臂，车体安装角
%可以分析gnss缺失的情况
%input: 
...
%                   M2(3,:) M1(3,:)    zeros(1,15) M3(3,1) 0;
        ...
        kf.Rk = diag([[100; 100; 100;].*pi/180/60;[0.1;0.1;0.1];])^2;                      %[0.5;0.5] 姿态速度匹配  
        Zk = [0.5*(z(3,2)-z(2,3)); 
              0.5*(z(1,3)-z(3,1)); 
              0.5*(z(2,1)-z(1,2));
              vel-vnm;
